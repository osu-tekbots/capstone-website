<?php
/**
 * This page handles client requests to modify or fetch courses-related data. All requests made to this page should
...
use Api\PreferredCoursesActionHandler;
...
$handler = new PreferredCoursesActionHandler($projectsDao, $usersDao, $keywordsDao, $categoriesDao, $preferredCoursesDao, $mailer, $configManager, $logger);
