...
else if(isset($_POST["exportAllProjects"]))
{
	...
	if(count($projects) > 0) {
		...
		$data ="Status". "," ."Proposer". "," ."Affiliation". "," ."Email". "," . "Phone". "," ."Additional Emails". "," . "Title". "," ."Focus". "," ."Description". "," ."Motivation". "," ."Category". "," ."Objectives". "," ."keyword list". "," . "min qualifications". "," ."pref qualifications". "," ."nda". ",". "number groups" ."," ."website". "," ."video". "," ."special comments". "\n";
